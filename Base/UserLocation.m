...
- (void)UserLocation{
    ...
    [self.locationManager requestLocationWithReGeocode:YES completionBlock:^(CLLocation *location, AMapLocationReGeocode *regeocode, NSError *error) {
        ...
        if (regeocode) {
            ...
            self.cityName = [NSString stringWithFormat:@"%@ %@",regeocode.city,regeocode.district];
            [WDNotificationCenter postNotificationName:XLocationCityName object:self.cityName];

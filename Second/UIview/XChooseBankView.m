...
- (void)setupView
{
    ...
    [cancleButton setTitleColor:XColorWithRGB(252, 92, 109) forState:UIControlStateNormal];
    ...
    [sureButton setTitleColor:XColorWithRGB(252, 92, 109) forState:UIControlStateNormal];
